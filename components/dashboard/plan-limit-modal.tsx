    ...
    switch (feature) {
      ...
      case 'invoice':
        return {
          ...
          description: `Vous avez atteint la limite mensuelle de factures de votre plan actuel.`,
          icon: FileText,
          current: 0,
          max: plan?.monthlyInvoiceLimit || 0,
          upgradeMessage: 'Upgradez votre plan pour traiter plus de factures chaque mois.'
        }
      default:
        return {
